...
3. Copy toàn bộ nội dung file [jms_assistant.user.js](trongluong-v2/jms-extension/jms_assistant.user.js) trong dự án của anh dán đè vào màn hình soạn thảo.
...
* Anh chỉ cần click đúp chuột vào file **`trongluong-v2/KHOI_DONG_HE_THONG.bat`**:
...
* Click đúp chuột vào file **`trongluong-v2/KHOI_DONG_HE_THONG.command`** để tự động mở tab Terminal mới chạy Server và bật ứng dụng Desktop Dashboard trên màn hình máy Mac.
...
2. Click đúp chuột vào file **`trongluong-v2/Build_IPA_MienPhi.command`**.
